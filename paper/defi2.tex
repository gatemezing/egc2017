...
\titrecourt{Un outil générique et personnalisable pour la visualisation de données géospatiales}
...
\titre{Un outil générique et personnalisable pour la visualisation de données géospatiales}
...
\affiliation{
    \affil{1}Univ Lyon, MINES Saint-\'Etienne, CNRS, Laboratoire Hubert Curien UMR 5516, \\F-42023 Saint-\'Etienne, France\\
          \{prenom.nom\}@emse.fr\\
    %
    \affil{2}Mondec, \\ 35 boulevard Strasbourg, Paris, France\\
